...
define add_opencv_module
    ...
    $(warning ----------------add_opencv_module $(OPENCV_LIBS_DIR)/libopencv_$1.$(OPENCV_LIB_SUFFIX)----------------------)
...
define add_opencv_3rdparty_component
    include $(CLEAR_VARS)
    LOCAL_MODULE:=$1
    $(warning ----------------add_opencv_3rdparty_component $(OPENCV_3RDPARTY_LIBS_DIR)/lib$1.a----------------------)
...
ifeq ($(OPENCV_MK_$(OPENCV_TARGET_ARCH_ABI)_ALREADY_INCLUDED),)
    ifeq ($(OPENCV_INSTALL_MODULES),on)
        ...
        $(foreach module,$(OPENCV_LIBS),$(eval $(warning ----------------111 $(module)----------------------)))

    endif

    $(foreach module,$(OPENCV_3RDPARTY_COMPONENTS),$(eval $(call add_opencv_3rdparty_component,$(module))))
    $(foreach module,$(OPENCV_3RDPARTY_COMPONENTS),$(eval $(warning ----------------222 $(module)----------------------)))
